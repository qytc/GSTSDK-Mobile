...
import io.qytc.gst.widget.TRTCBeautySettingPanel;
import io.qytc.gst.widget.TRTCMoreDialog;
import io.qytc.gst.widget.TRTCSettingDialog;
import io.qytc.gst.widget.videolayout.TRTCVideoLayoutManager;
...
public class TRTCMainActivity extends Activity implements View.OnClickListener, TRTCBeautySettingPanel.IOnBeautyParamsChangeListener, TRTCSettingDialog.ISettingListener, TRTCMoreDialog.IMoreListener, TRTCVideoLayoutManager.IVideoLayoutListener {
    ...
    public static final String KEY_APP_SCENE  = "AppScene";
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.trtc_ib_back) {
            finish();
        } else if (i == R.id.trtc_iv_switch_role) {
            switchRole();
        } else if (i == R.id.trtc_iv_mode) {
        ...
        } else if (i == R.id.trtc_iv_setting) {
            mSettingDialog.show();
        } else if (i == R.id.trtc_iv_more) {
            mMoreDialog.show(mIsConnectingOtherRoom);
        } else if (i == R.id.trtc_btn_sure) {
            startLinkMic();
        } else if (i == R.id.trtc_btn_cancel) {
            hideLinkMicLayout();
        } else if (i == R.id.trtc_rl_main_qrcode) {
